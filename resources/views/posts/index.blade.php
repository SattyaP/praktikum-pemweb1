                ...
                @forelse ($posts as $post)
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="card hover-effect h-100">
                            <a href="{{ route('posts.show', $post->code_post) }}" class="card-body text-decoration-none d-flex flex-column justify-content-between align-items-center">
                                <img src="{{ asset('/storage/posts/' . $post->image) }}"
                                    class="img-fluid mb-3 object-fit-contain" alt="{{ $post->title }}">
                                <div>
